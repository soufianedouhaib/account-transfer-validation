...
const DEFAULT_USERS = [
  { email: 'advisor1@aaico.demo', role: 'advisor', password: 'Advisor1-2026', name: 'Demo advisor one' },
  { email: 'advisor2@aaico.demo', role: 'advisor', password: 'Advisor2-2026', name: 'Demo advisor two' },
  { email: 'reviewer1@aaico.demo', role: 'reviewer', password: 'Review1-2026', name: 'Demo reviewer one' },
  { email: 'reviewer2@aaico.demo', role: 'reviewer', password: 'Review2-2026', name: 'Demo reviewer two' },
  { email: 'soufiane.douhaib@aaico.com', role: 'admin', password: 'Admin-2026', name: 'Soufiane Douhaib' }
];

const ROLE_LABEL = { advisor: 'Advisor', reviewer: 'Reviewer', admin: 'Administrator' };
...
function requireReviewer(req, res, next) {
  ...
  if (!canReview(req.user)) {
    return res.status(403).json({ error: 'This area is for reviewers.' });
  }
  next();
}
...
module.exports = {
  ...
  demoAdvisors: parsed.usingDefaults
